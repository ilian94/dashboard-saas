    ...
    <div style={{ minHeight: '100vh', background: '#080b12', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 16px', fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      <div style={{ maxWidth: 560, width: '100%' }}>
        ...
        <button
          ...
          style={{ width: '100%', background: 'linear-gradient(135deg,#6366f1,#8b5cf6)', color: '#fff', border: 'none', padding: '16px 36px', borderRadius: 12, fontWeight: 800, fontSize: 16, cursor: 'pointer', letterSpacing: '0.01em' }}
        >
          Go to Dashboard →
        </button>
