...
const plans = [
  ...
  { name: 'Scale', price: '$459', desc: 'For growing teams.', priceId: 'price_1TZI51Fbv1QHIqBxfvYIkKRh', features: ['2,000 call minutes/month', '1 phone number', 'Google Calendar sync', 'AI call summaries', 'Custom business name'], popular: true },
  { name: 'Business', price: '$879', desc: 'For high-volume operations.', priceId: 'price_1TZI51Fbv1QHIqBxmfldnApH', features: ['6,000 call minutes/month', '1 phone number', 'Google Calendar sync', 'AI call summaries', 'Full script customization', 'SMS confirmation after booking', 'Call recording'] },
];
